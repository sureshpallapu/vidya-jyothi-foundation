...
function FounderMessage() {
  ...
  const founderName = settings?.founder_name || "Suresh";
  const founderDesignation = settings?.founder_designation || "Founder";
  const trustName = settings?.trust_name || "Vidya Jyothi Foundation";
  const founderMessage =
    settings?.founder_message ||
    "Education is not merely about earning a degree; it is about unlocking human potential, creating opportunities, and building a future where no dream is limited by financial hardship.";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10 border-l-4 border-yellow-500 pl-6">
              ...
              <p className="text-slate-500 mt-2">{founderDesignation}</p>
